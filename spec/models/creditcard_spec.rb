...
describe Creditcard do
  describe '#create' do
    ...
    it "is invalid without a credit_number" do
      ...
      @user.valid?
      expect(@user.errors[:"creditcards.credit_number"]).to include("can't be blank", "is invalid")
    end
    ...
    it "is invalid if credit_number is not a correct credit card numbers" do
      ...
      @user.valid?
      expect(@user.errors[:"creditcards.credit_number"]).to include("is invalid")
    end
    ...
    it "is invalid without a limit_month" do
      ...
      @user.valid?
      expect(@user.errors[:"creditcards.limit_month"]).to include("can't be blank", "is invalid")
    end
    ...
    it "is invalid if limit_year is not a half_witdh numbers" do
      @user.creditcards = build_list(:creditcard, 1, limit_month: "--")
      @user.valid?
      expect(@user.errors[:"creditcards.limit_month"]).to include("is invalid")
    end
    ...
    it "is invalid without a limit_year" do
      ...
      @user.valid?
      expect(@user.errors[:"creditcards.limit_year"]).to include("can't be blank", "is invalid")
    end
    ...
    it "is invalid if limit_year is not a half_witdh numbers" do
      @user.creditcards = build_list(:creditcard, 1, limit_year: "--")
      @user.valid?
      expect(@user.errors[:"creditcards.limit_year"]).to include("is invalid")
    end
    ...
    it "is invalid without a security_number" do
      ...
      @user.valid?
      expect(@user.errors[:"creditcards.security_number"]).to include("can't be blank", "is invalid")
    end
